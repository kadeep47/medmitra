...
export const DR_SHARMA_DATA: RelationFolder = {
  ...
  chat: [
    ...
    { id: 'd3', senderId: 'f4', type: 'image', content: 'Interesting read on how sleep affects BP levels in seniors.', timestamp: NOW - (ONE_DAY * 7), isRead: true, metadata: { imageUrl: '/images/news_bp.jpg' } },
    { id: 'd4', senderId: 'f4', type: 'text', content: 'Make sure you get 7 hours of rest.', timestamp: NOW - (ONE_DAY * 7) + 1000, isRead: true },
    { id: 'd5', senderId: 'f4', type: 'image', content: 'Recent findings on walking and insulin sensitivity.', timestamp: NOW - (ONE_HOUR * 5) - 5000, isRead: false, metadata: { imageUrl: '/images/news_diabetes.jpg' } },
